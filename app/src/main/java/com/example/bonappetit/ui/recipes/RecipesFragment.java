                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                list.add(new RecipesModel(document.getData().get("Image").toString(),document.getData().get("Name").toString(),document.getData().get("Ingredients").toString(),document.getData().get("Method").toString()));
                            }
